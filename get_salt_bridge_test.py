...
def add_H_atoms_into_pad_files():
  SB_bonds_file = ["1ifr.pdb", "1cbr.pdb", "1pga.pdb","1eq5.pdb", "2qmt.pdb", "2on8.pdb", "2onq.pdb"]
...
def prepare_cif_for_pdb_file():
  SB_bonds_file = ["1ifrh.pdb","1cbrh.pdb","1pgah.pdb","1eq5.pdb","2qmth.pdb","2on8h.pdb","2onqh.pdb"]
  for pdb_file in SB_bonds_file:
